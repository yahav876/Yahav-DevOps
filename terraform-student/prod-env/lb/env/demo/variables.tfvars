...
lb_website = {
  ...
  backend_port_2     = "1337"
  backend_port_3     = "22"
  certificate_arn    = "arn:aws:acm:us-east-2:294650027016:certificate/f9e0df8b-612f-45cb-a3f5-54a312de6ab2"
  port_1             = "80"
  port_2             = "1337"
  port_3             = "8080"
  tag_key            = "ManagedBy"
...
lb_allinone = {
  ...
  certificate_arn = "arn:aws:acm:us-east-2:294650027016:certificate/7ecfadcb-93c7-4740-97f0-5721bd0a9ac4"
  port_1          = "9001"
  port_2          = "22"
  port_3          = "9000"
  port_4          = "9001"
