...
cf = {
  ...
  aliases             = ["circlesup.com"]
  comment             = "prod-cloudfront"
  enabled             = true
...
first_origin = {
  ...
  name                   = "website"
  domain_name            = "circles-website-prod.s3-website.us-east-2.amazonaws.com"
  http_port              = 80
  https_port             = 443
...
second_origin = {
  ...
  name                   = "apanel"
  domain_name            = "circles-apanel-prod.s3-website.us-east-2.amazonaws.com"
  http_port              = 80
  https_port             = 443
  origin_protocol_policy = "http-only"
  origin_ssl_protocols   = ["TLSv1.2", "TLSv1", "TLSv1.1", "SSLv3"]
...
third_origin = {
  ...
  name                   = "webapp"
  domain_name            = "circles-webapp-prod.s3-website.us-east-2.amazonaws.com"
  http_port              = 80
  https_port             = 443
  origin_protocol_policy = "http-only"
  origin_ssl_protocols   = ["TLSv1.2", "TLSv1", "TLSv1.1", "SSLv3"]
